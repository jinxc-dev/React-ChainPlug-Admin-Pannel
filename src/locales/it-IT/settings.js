export default {
  'app.settings.menuMap.basic': 'Settaggi base',
  'app.settings.menuMap.security': 'Configurações de Segurança',
  'app.settings.menuMap.reset.password': 'Resetta Password',
  'app.settings.menuMap.binding': 'Vinculação de Conta',
  'app.settings.menuMap.notification': 'Nuova Notifica',
  'app.settings.basic.avatar': 'Avatar',
  'app.settings.basic.change-avatar': 'Alterar avatar',
  'app.settings.basic.email': 'Email',
  'app.settings.basic.email-message': 'Por favor insira seu email!',
  'app.settings.basic.firstname': 'Nome',
  'app.settings.basic.lastname': 'Cognome',
  'app.settings.basic.firstname-message': 'Por favor insira seu Nome!',
  'app.settings.basic.lastname-message': 'Por favor insira seu Cognome!',
  ...
  'app.settings.basic.phone': 'Numero di telefono',
  'app.settings.basic.phone-message': 'Per favore inserisci il tuo nome!',
  'app.settings.basic.update': 'Aggiorna Informazioni',
