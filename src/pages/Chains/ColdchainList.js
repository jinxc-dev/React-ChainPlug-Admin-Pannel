...
class CertificateDocumentList extends Component {
  ...
  gotoDetailForm = id => {
    router.push(`/coldchain/coldchain_form/${id}`);
  };
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title={<FormattedMessage id="menu.coldchain.Coldchain" />}>
